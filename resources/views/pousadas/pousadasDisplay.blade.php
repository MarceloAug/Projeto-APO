    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-2">
                        <a class="btn btn-block btn-info active" href="/pousadas/adicionar">Novo</a>  
                    </div>
                    <div class="col-md-2">
                        <a class="btn btn-block btn-outline-success active" href="/pousadas/FormUpdate/{{$pousada->id}}">Editar</a>
                    </div>  
                </div>
            </div>
        </div>
